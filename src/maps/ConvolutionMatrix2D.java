...
public class ConvolutionMatrix2D extends Matrix2D {
	...
	/**
	 * @Precond : the kernel and the input are matrices
	 */
	@Override
	public void compute()
	{
		...
		double[] input = params.get(INPUT).getValues();
		double[] kernel = params.get(KERNEL).getValues();
...
//						}
//						try{
//						sum += input[ii + jj*vx] * kernel[mm +  nn*kx];
//						}catch (Exception e) {
//							//System.out.println("out of bounds");
//						}
//						//System.out.println(input[ii][jj]+ " * "+ kernel[mm][nn]);
//					}
//				}
