...
import console.TextAreaInOut;
import console.TextFieldIn;
...
public class GUI extends JApplet {
	...
	public GUI(Runner runner,Root root, URL contextPath,Dimension dim){
		this.runner = runner;
...
//			System.setErr(getOut());
	...
	/**
	 * Change the displayed model if it is different from the current one
	 * @param model
	...
	protected void constructGUI() throws MalformedURLException, CommandLineFormatException, IOException, NullCoordinateException
	{
		...
		//Show the model param panel directly
		...
		public void run() {
			...
			while(true)
			{
				try {
					...
					//System.out.println(GUI.INVITE+command);
