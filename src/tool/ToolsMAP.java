...
/**
 * Ensemble d'outil necessaire à l'études des maps.
 * @author ncarrara
 */
public class ToolsMAP {
     ...
     * ne fonctionne pas sur les maps plus grandes que 43*43 (a peu près) à cause de la pile trop petite
     ...
     * 
     * Cette fonction est destinée aux maps wrapped
     * 
