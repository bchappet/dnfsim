...
//	    excitation = new TrajectoryUnitMap(EXCITATIONMAP,vdt,refSpace,resetExc,pTau,input,interactionE,ph) {
//			@Override
...
//			}
//			private double computation2(double potential,double tau, double input,
//					double interactionE,double h  ) {
//					return Math.max(0, potential + dt.get()/tau*(-potential + input + h) + 1/tau*interactionE);
//			}
//		};
		
		excitation = new Map(EXCITATIONMAP,new SpikingPotentialUM(),vdt,refSpace,resetExc,pTau,input,interactionE,ph);
		
//		 inhibition = new TrajectoryUnitMap(INHIBITIONMAP,vdt,refSpace,resetInhi,pTau,input,interactionI,ph) {
//			@Override
//			public double computeActivity(double... param)  {
