...
/**
 * This is the Runnable which will handle the main.java.model computation.
 * 
 ...
 * Otherwise, if a main.java.gui is present, the thread wait for play to be true.
 * 
 * As several thread can be launched with the same main.java.model, the core used is given by the "core" attribute.
 * 
 * 
 * 
 * @author bchappet
...
public class Runner  implements Runnable{
	...
	/**If true, we exit main.java.applet**/
	...
	/**share with the GUI if there is a main.java.gui**/
	protected Lock lock;
	...
	/**
	 * One update of the main.java.model**
	 * of time in seconds
	...
	/**
	 * Update the main.java.model
	 * time in seconds
	 * @throws CommandLineFormatException
	 */
	protected void update(BigDecimal timeToReach) throws CommandLineFormatException
	{
		lock.lock(); //this lock ensure that we do not change the displayed main.java.model or change parameters during computation
		try{
	...
	public void run(){
		...
		if(gui != null){ //if there is a main.java.gui, we wait for play
	...
	/**
	 * Save main.java.statistics in the given file
	 * @param filename
	 * @throws IOException
	 */
	...
	/**
	 * This will be to change main.java.model resolution
