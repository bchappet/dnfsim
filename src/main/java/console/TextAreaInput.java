...
/**
 * TODO presently, the main.java.input is handled with a JTextField
 * @author bchappet
 *
 */
public class TextAreaInput extends InputStream implements DocumentListener{
	...
	//  Reads the next byte of data from the main.java.input stream.
	//	The value byte is returned as an int in the range 0 to 255. 
	//	If no byte is available because the end of the stream has been reached,
	//	the value -1 is returned. This method blocks until main.java.input data is available, 
