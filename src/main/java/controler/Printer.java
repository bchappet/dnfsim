...
public class Printer{
    ...
    public static final String SAVE_MAP = "savemap"; //save map at every computation ex savemap=Inputs,Focus
    public static final String SAVE_PATH = "savepath";//save path for maps
    //It will give : Inputs_idIteration_computation.csv
    ...
    public static void runDNFSim(String[] args){
        ...
        try {
            ...
            String[] mapsToSave = new String[0];
            if(savemapStr!=null)
                mapsToSave = savemapStr.split(",");


            String savePath = System.getProperty(SAVE_PATH);
            ...
            for(int i = 0 ; i < nbCore ; i++){
                if(iterations[i] > 0){
                    ...
                    runners[i] = new Runner(printer,model,contextScript,scenario,
                            showGui,mapsToSave,savePath, iterationIds.get(i));
