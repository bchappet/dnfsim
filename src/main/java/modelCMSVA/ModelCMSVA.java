...
import main.java.input.ConfigurationInput;
import main.java.input.ReaderInput;
import main.java.input.UnitModelInputBrightness;
import main.java.input.UnitModelInputHSB;
import main.java.lucasKanade.UnitModelLucasKanade;
...
public class ModelCMSVA extends Model {
    ...
    public static final String CONV_AFF_FOCUS_TO_INPUT = "convolution focus to main.java.input";
    public static final String CONV_LAT_FOCUS_TO_FOCUS = "convolution focus to focus";
    public static final String WEIGHT_AFF_FOCUS_INPUT = "weight focus from main.java.input";
    ...
    public static final String WEIGHT_AFF_FEF_INPUT = "weight FEF from main.java.input";
    ...
    /**
     * For understand the name of the following main.java.maps : c = convolution l =
     * lateral f = focus fef = fef vm = working memory t = to w = weigth i =
     * main.java.input a = afferant
     */
    /* main.java.input */
    ...
    protected void initializeParameters() throws CommandLineFormatException, NullCoordinateException {
        ...
        //Extended main.java.space is a -1,1 (instead of -0.5,0.5) main.java.space
...
//        metaData.cpf = 1; // => 10 frames par secondes vu que le main.java.model est a 10 cps
//        UnitModel inputVideoUM = new UnitModelInputBrightness/*HSB*/( initScript.get(CNFTCommandLine.INPUT_DT), 
//                                        space2d,
//                                        metaData, 
...
//
        ...
        input = new Map("main.java.lucasKanade", lucasKanadeUM);
...
//        AbstractMap[] tracks = trackable.toArray(new AbstractMap[]{trackable.get(0)});
    ...
    /**
     * Change the main.java.model environement if needed Every scenario update which are
     * not automaticaly computed by the main.java.model params architecture should be
     ...
     * reconstructing every tracks would change the main.java.statistics and
