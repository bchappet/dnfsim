 ...
 * 
 * The standard way to access its value is with the get(Double ... main.java.coordinates)
 ...
 * using initScript line for instance see {@link Var}). In this case, a bottom up
