...
public class FramedSpaceIterator implements Iterator<Unit> {
	...
	/**
	 * Return the next index inside the frame or -1 if we are outside the main.java.space
	 * @return
	 */
	...
	protected static boolean inside(int realIndex2,Space space) {
		...
		if(resFrameSpace != resSpace){
			...
			//System.out.println("resSpace : " + resSpace + " resFrame main.java.space : " + resFrameSpace);
	...
	/**
	 * Shift the index of framed to the full main.java.space resolution
	 * @param index
	 * @return
	 */
