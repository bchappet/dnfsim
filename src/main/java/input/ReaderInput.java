...
public class ReaderInput implements InterfaceReader {
     ...
     * @param cps fps de sortie, ie le nombre de computation par seconde effectué par le main.java.model qui utilise l'unit main.java.model lié à ce reader
     ...
     * @param main.java.space sur quel espace on travail (on récupère la résolution)
     */
