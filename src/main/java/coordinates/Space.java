...
public abstract class Space implements Cloneable,Node{
	...
	/**Index of main.java.coordinates**/
	...
	/**
	 * Initialize discrete main.java.space values : discreteSize and discreteVolume
	 * @param resolution
	 */
	...
	/**
	 * Return the integer (descretized) main.java.coordinates corresponding
	 * to this refSpace
	 * @original coor
	 * @return
	 */
	...
	/**
	 * Return the double (in the continuous refSpace) main.java.coordinates corresponding
	...
	/**
	 * Continuous main.java.coordinates!!
	 * Return a wrapped version of the coor if wrap = true
	 * Otherwise the outside coord unit is set to null (outsie the frame main.java.space)
	 * 
	 ...
	 * @param coor : main.java.coordinates to transform into an index
...
//		System.out.println("NewCoord : " + Arrays.toString(newCoord));
	...
	public Double[] indexToCoord(int index) {
		...
		else
		{
			...
			///////////////////////////////////////////////////
			//Then we affect each main.java.coordinates of the the non null dimension
			///////////////////////////////////////////////////
	...
	/**
	 * Return the center (continuous) main.java.coordinates of the refSpace :
	...
	/**
	 * Return the norme of the main.java.space
	 * for size 1 * 1 => sqrt(2)
	 * @return
	 */
