...
public class Bubble {
    ...
    Point centre;
    main.resources.tool.PointContinu centreDouble;
    Point nord;
    Point sud;
    Point est;
    Point ouest;
    ...
    public Bubble(int resolutionMap) {
        ...
        centreDouble = new main.resources.tool.PointContinu();
        centre = new Point();
        nord = new Point();
        sud = new Point();
        est = new Point();
    ...
    public void caculerCentreBullePrecision() {
        main.resources.tool.PointContinu nordDouble = new main.resources.tool.PointContinu(nord.x + 0.5, nord.y + 0.5);
        main.resources.tool.PointContinu sudDouble = new main.resources.tool.PointContinu(sud.x + 0.5, sud.y + 0.5);
        main.resources.tool.PointContinu estDouble = new main.resources.tool.PointContinu(est.x + 0.5, est.y + 0.5);
        main.resources.tool.PointContinu ouestDouble = new main.resources.tool.PointContinu(ouest.x + 0.5, ouest.y + 0.5);
