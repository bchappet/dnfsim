...
public class DisplayWebcamVideo
{
  ...
  public static void main(String[] args)
  {
    ...
    params.setValue("video_size", "1280*1024");    //320*240
      System.out.println("device name : "+deviceName);
    // Open up the container
    int retval = container.open("/dev/video0", IContainer.Type.READ, format,
    ...
    if (videoCoder.getPixelType() != IPixelFormat.Type.BGR24)
    {
      ...
      if (resampler == null)
        throw new RuntimeException("could not create color main.java.space resampler for: " + deviceName);
    }
    /*
